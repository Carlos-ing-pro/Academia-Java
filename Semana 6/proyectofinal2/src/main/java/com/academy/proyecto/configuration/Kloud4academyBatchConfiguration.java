...
public class Kloud4academyBatchConfiguration {
    ...
    public FlatFileItemReader reader() {
        return new FlatFileItemReaderBuilder<>()
            ...
            .fieldSetMapper(new BeanWrapperFieldSetMapper() {{
                setTargetType(InventarioPc.class);
            }})
            .build();
    }
    ...
    public JdbcBatchItemWriter writer(DataSource dataSource) {
        return new JdbcBatchItemWriterBuilder<>()
            ...
            .sql("INSERT INTO product (productId, pcname, pcmodelo, zona) VALUES (:productId, :productName, :productDesc, :price)")
    ...
    public Step step1(JobRepository jobRepository, PlatformTransactionManager transactionManager, JdbcBatchItemWriter writer) {
        return new StepBuilder("step1", jobRepository)
            .<InventarioPc, InventarioPc>chunk(5, transactionManager)
            .reader(reader())
            .processor(processor())
            .writer(writer)
            .build();
